...
export const cancellationAnalyticsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    getCancellationSummary: builder.query<CancellationAnalyticsSummary, void>({
      query: () => ({
    ...
    getCancellationTrends: builder.query<ChartPoint[], void>({
      query: () => ({
    ...
    getCancellationReasonsStats: builder.query<ChartPoint[], void>({
      query: () => ({
    ...
    getCancellationByCities: builder.query<ChartPoint[], void>({
      query: () => ({
    ...
    getCancellationByCategories: builder.query<ChartPoint[], void>({
      query: () => ({
